...
const messages: Record<'en' | 'zh', LocaleMessages> = {
  en: {
    ...
    about: {
      ...
      website: 'https://liubohung.github.io/MyBio',
      github: 'liubohung',
      kaggle: 'pohungliu',
      gender: 'Gender : Male',
      ...
      skills: [
        {
          ...
          skillName: ['Python', 'C', 'JavaScript', 'Typescript'],
        },
        {
          jobName: 'Web Frameworks & Libraries',
          skillName: ['Vue 3', 'Naive UI', 'Quasar', 'FastAPI'],
        },
        {
        ...
        },
        {
          ...
          skillName: ['Matplotlib', 'Seaborn', 'D3.js', 'Tableau public'],
        },
        {
          jobName: 'Database',
  ...
  zh: {
    ...
    about: {
      ...
      summaryTitle: '個人簡介',
      summary:
        '我畢業於逢甲大學資訊工程學系，以及國立東華大學財務金融研究所。大學的學習重點在於資料分析與機器學習演算法的應用，碩士研究則聚焦於資產定價與量化分析。熟悉多種程式語言，並以 Python 為主要工具，應用於資料的清理、模型建構與預測分析。因為有跨領域的求學背景，逐步建立起統計學、計量經濟學、機器學習與程式實務間的整合基礎，能將理論轉化為實務操作，並能處理多種不同類型目標的任務與資料。在大學與研究所期間，我曾擔任多門課程助教與研究助理，這讓我在資料處理與專案規劃上累積實務經驗。學士班參與過影像處理、機器學習與前後端相關專案，碩士班期間的訓練，使我廣泛閱讀論文，並針對 TEJ 臺灣上市上櫃市場資料進行深入研究，從資料清洗、特徵工程到模型設計，以臺灣市場資料加以印證，挖掘臺灣市場的獨特之處，在過程中，更進一步培養了獨立思考與系統化解決問題的能力。同時，我也積極參加 Kaggle 等資料分析競賽，累積自己的能力與經驗。這些經驗不僅加深了我對資料科學的理解，也讓我在團隊合作、溝通協調與專案執行上更為成熟，並在反覆的挑戰中養成細心與耐心的態度。我的核心優勢在於快速學習與積極執行，並且不會懼怕困難，喜歡具有挑戰性的任務。能夠深入了解、分析問題，能在面對新工具與挑戰時迅速掌握要點，並提出觀點與解決方案。我期望能將這些能力，應用於資料分析與決策支持工作，協助發掘潛在價值並轉化為實際成果。',
